...
import bannerImg from "../../public/images/about-banner.jpeg";
import fusionImg1 from "../../public/images/fusion1.jpg";
import fusionImg2 from "../../public/images/fusion2.jpg";
import fusionImg3 from "../../public/images/fusion3.jpg";
import fashionImg1 from "../../public/images/fashion1.jpg";
import fashionImg2 from "../../public/images/fashion2.jpg";
import fashionImg3 from "../../public/images/fashion3.jpg";
import fashionImg4 from "../../public/images/fashion4.jpg";
  ...
  return (
    <div className="about">
      <div className="about-banner w-full relative flex items-center">
        ...
        <Image alt="" className="w-full" src={bannerImg}></Image>
      </div>
      ...
      <div className="about-fusion md:px-4 lg:px-0 mt-24 lg:max-w-7xl max-w-2xl mx-auto">
        ...
        <div className="about-fusion-wrap grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-full">
          <div className="about-fusion-item mb-12">
            <Image alt="" className="w-full" src={fusionImg1}></Image>
          ...
          <div className="about-fusion-item mb-12">
            <Image alt="" className="w-full" src={fusionImg2}></Image>
            <div className="fusion-item-content px-12 text-center mt-6">
          ...
          <div className="about-fusion-item mb-12">
            <Image alt="" className="w-full" src={fusionImg3}></Image>
            <div className="fusion-item-content px-12 text-center mt-6">
      ...
      <div className="about-banner-fashion mt-16 mb-8 relative lg:max-w-7xl grid md:grid-cols-2 max-w-2xl mx-auto">
        ...
        <div className="banner-fashion-image">
          <Image alt="" src={fashionImg1}></Image>
        </div>
      </div>
      ...
      <div className="about-banner-fashion banner-fashion-violet relative lg:max-w-7xl grid md:grid-cols-2 max-w-2xl mx-auto">
        ...
        <div className="banner-fashion-image">
          <Image alt="" src={fashionImg2}></Image>
        </div>
      </div>
